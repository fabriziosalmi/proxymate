...
<p align="center">
  ...
  <a href="https://github.com/fabriziosalmi/proxymate/releases/latest"><img src="https://img.shields.io/badge/release-v0.9.51-blue.svg" alt="Latest release"></a>
...
Download `Proxymate-0.9.51.dmg` from the [latest release](https://github.com/fabriziosalmi/proxymate/releases/latest), verify the hash, and drag the app into `/Applications`:

```bash
shasum -a 256 ~/Downloads/Proxymate-0.9.51.dmg
# db11e2499397453035a88587032df7355a562e60cd3f9220476de7caabc47f6a
```
