...
final class ExfiltrationTests: XCTestCase {
    ...
    func testGitHubPATRegex() throws {
    ...
    func testSlackBotTokenRegex() throws {
    ...
    func testPrivateKeyRegex() throws {
    ...
    func testPasswordInURLRegex() throws {
    ...
    func testItalianFiscalCodeRegex() throws {
    ...
    func testNormalTextNoMatch() throws {
